...
Class AccesoAFIP_ML_PROD
    ...
    Public Function ObtenerRespuestaAFIP(ByVal pObjComprobantesFE As Comprobantes_ml, ByVal pObjTicket As Ticket, ByVal pCuitEmpresa As String) As ar.gov.afip.wsfe_v1.FECAEResponse
        Try
    ...
    Private Function CrearObjetoComprobanteFE_Desde_ResultGet(pResult As ar.gov.afip.wsfe_v1.FECompConsultarResponse) As Comprobantes_ml
        Try
    ...
    Private Function CrearComprobanteML_Desde_ResultGet(pResult As ar.gov.afip.wsfe_v1.FECompConsultarResponse) As Comprobantes_ml
        Try
    ...
    Private Function CrearDetalleRequest_desde_ComprobanteML(pObjComprobantesML As Comprobantes_ml, pCbteDesde As Integer, pCbteHasta As Integer) As ar.gov.afip.wsfe_v1.FECAEDetRequest
        Try
