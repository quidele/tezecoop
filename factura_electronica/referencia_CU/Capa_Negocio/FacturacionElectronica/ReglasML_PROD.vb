...
Public Class ReglasML_PROD
    ...
    Sub New(ByVal pListaConexiones As List(Of Conexion), ByVal pAmbiente As String, ByVal pTipoDeConexion As String, pAppName As String)
        MyBase.New(pListaConexiones, pAmbiente, pTipoDeConexion, pAppName)
    End Sub



    Private Sub CompletarComprobanteConResponse(ByRef pObjComprobante As Comprobantes_ml, ByRef pObjRespuesta As ar.gov.afip.wsfe_v1.FECAEResponse, ByVal pEstadoEnvio As String)
        Try
    ...
    Public Function InsertarComprobantes(ByVal pIdSolicitud As Integer, ByRef pObjConexion As Conexion) As Boolean Implements IReglasFE.InsertarComprobantes
        ...
        Try
            ...
            Dim objResultadoSP As ResultadoSP
            ...
            If Not MyBase.InsertarComprobantesML(pIdSolicitud, objAdmConexionesBD) Then
                objAdmConexionesBD.Rollback_Transaction()
                Exit Function
            End If

            If (MyBase.ObjetoObtenido IsNot Nothing AndAlso TypeOf MyBase.ObjetoObtenido Is ResultadoSP) Then
                objResultadoSP = CType(MyBase.ObjetoObtenido, ResultadoSP)
                If objResultadoSP.resultado.ToString.Trim.ToUpper.Equals("OK") Then
                    objResultadoSP.descripcion = objResultadoSP.resultado
                    codigoObservacion = 1
                ElseIf objResultadoSP.resultado.ToString.Trim.ToUpper.Equals("ERROR") Then
                    codigoObservacion = -1
                End If

                If Not MyBase.InsertarObservaciones(pIdSolicitud, codigoObservacion, "Preparación de comprobante a enviar: " + objResultadoSP.descripcion.ToString, objAdmConexionesBD) Then
                    objAdmConexionesBD.Rollback_Transaction()
                    Exit Function
                End If
            End If
    ...
    Private Function ObtenerComprobanteFE(ByVal pIdSolicitud As Integer, ByRef pObjConexion As Conexion) As Comprobantes_ml
        Try
            Me.Clear()

            Dim objComprobanteML As Comprobantes_ml

            If Not MyBase.ObtenerComprobantesML(pIdSolicitud, pObjConexion) Then
            ...
            objComprobanteML = CType(MyBase._objetoObtenido, Comprobantes_ml)

            objComprobanteML.DetalleIVA = MyBase.OtenerListaDetalleIVA(pIdSolicitud, pObjConexion)
            objComprobanteML.DetalleTributos = MyBase.OtenerListaDetalleTributo(pIdSolicitud, pObjConexion)
            objComprobanteML.CbtesAsociados = MyBase.OtenerListaComprobantesAsociados(pIdSolicitud, pObjConexion)
    ...
    Public Function ObtenerDatosUltimoComprobante(ByVal pPtoVta As Integer, ByVal pCbteTipo As Integer, ByVal pCbteNro As Integer, ByVal pDnSource As String, _
        ...
        Try
            Dim objComprobanteFE As Comprobantes_ml
    ...
    Public Function ObtenerComprobanteFE(ByVal pPtoVta As Integer, ByVal pCbteTipo As Integer, ByVal pCbteNro As Integer, ByVal pDnSource As String, _
                                        ByVal pDnDestination As String, ByVal pIdServicioNegocio As String, ByVal pCuitEmpresa As String, _
                                        ByVal pNombreCertificado As String, ByVal pDireccion As String, ByVal pMilisegundos As Integer, ByRef pObjConexion As Conexion) As Comprobantes_ml Implements IReglasFE.ObtenerComprobanteFE
        Try
            ...
            Return CType(objAccesoAFIP.ObjetoObtenido, Comprobantes_ml)
    ...
    Public Overloads Function ObtenerObservaciones(ByVal pIdSolicitudes As Integer, ByRef pObjConexiones As Conexion) As Boolean Implements IReglasFE.ObtenerObservaciones
        ...
        Try
            ...
            If Not MyBase.ObtenerObservaciones(pIdSolicitudes, pObjConexiones) Then
                Exit Function
            End If
    ...
    Public Function ObtenerSolicitudesEnviar_Lista(ByRef pObjConexion As Conexion) As List(Of Solicitud) Implements IReglasFE.ObtenerSolicitudesEnviar_Lista
        Try
            Return MyBase.ObtenerSolicitudesEnviarMercadoLocal_Lista(pObjConexion)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Public Function SolicitarCAE(ByVal pIdSolicitud As Integer, ByVal pDnSource As String, ByVal pDnDestination As String, ByVal pIdServicioNegocio As String, _
        ...
        Try
            ...
            Dim objComprobante As Comprobantes_ml = ObtenerComprobanteFE(pIdSolicitud, pObjConexion)
            ...
            If respuesta.ToUpper.Equals("R") Then
                ...
                For Each item As ar.gov.afip.wsfe_v1.FEDetResponse In objProdFECAEResponse.FeDetResp
                    ...
                    For Each elem_obs In item.Observaciones
                        ...
                        objObservaciones = New Observaciones(elem_obs.Code, elem_obs.Msg, pIdSolicitud)
    ...
    Public Function ValidarComprobanteEnvio(ByVal pIdSolicitud As Integer, ByRef pObjConexion As Conexion) As Boolean Implements IReglasFE.ValidarComprobanteEnvio
        ...
        Try
            ...
            listaSolicitudes = MyBase.ObtenerSolicitudesEnviarMercadoLocal_Lista(pObjConexion)

            objSolicitudEnvio = (From item As Solicitud In listaSolicitudes Where CInt(item.idSolicitud.ToString) = pIdSolicitud).ToList(0)

            'Validamos fechas
            If (From item As Solicitud In ListaObtenida Where CDate(item.fec_doc.ToString) < CDate(objSolicitudEnvio.fec_doc.ToString)).ToList.Count > 0 Then
            ...
            If objSolicitudEnvio.estado_envio.ToString.Trim.ToUpper.Equals("ASIGNADO") Then
                Me._error = "La factura está en estado ""Asignado"". Es probable que esté intentando enviar una factura duplicada. Consulte al proveedor del sistema."
                Exit Function
            End If
