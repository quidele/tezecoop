...
Public Interface IReglasFE
    ...
    Function ObtenerObservaciones(ByVal pIdSolicitudes As Integer, ByRef pObjConexiones As Conexion) As List(Of observaciones)
    ...
    Function ObtenerComprobanteFE(ByVal pPtoVta As Integer, ByVal pCbteTipo As Integer, ByVal pCbteNro As Integer, ByVal pDnSource As String, _
                                      ByVal pDnDestination As String, ByVal pIdServicioNegocio As String, ByVal pCuitEmpresa As String, _
                                      ByVal pNombreCertificado As String, ByVal pDireccion As String, ByVal pMilisegundos As Integer, ByRef pObjConexion As Conexion) As comprobantes_ml_Screen

    Function ReprocesarComprobante(ByVal pIdSolicitud As Integer, ByRef pObjConexion As Conexion) As observaciones
    ...
    Function SolicitarCAE(ByVal pIdSolicitud As Integer, ByVal pDnSource As String, ByVal pDnDestination As String, ByVal pIdServicioNegocio As String, ByVal pNombreCertificado As String, _
                          ByVal pDireccion As String, ByVal pCuitEmpresa As String, ByVal pMilisegundos As Integer, ByRef pObjConexion As Conexion) As List(Of observaciones)

    Sub ValidarComprobanteEnvio(ByVal pIdSolicitud As Integer, ByRef pObjConexion As Conexion)

    Sub ValidarEstadoReproceso(ByVal pEstado As String)
