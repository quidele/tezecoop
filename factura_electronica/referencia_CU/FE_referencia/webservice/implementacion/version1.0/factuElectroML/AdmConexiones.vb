...
Public Class AdmConexiones
    ...
    Public Shared rsSQLFE As Data.SqlClient.SqlDataReader
    ...
    Public Shared Function abrirConexionFE() As Boolean
        ...
        clave = Encriptado.DecryptText(clave_FE, usuario_FE)

        connSQL.ConnectionString = connectionString + ";Uid=" + usuario_FE + " ;Pwd=" + clave
    ...
    Public Shared Function ejecutarQuerySQLFE(ByVal pSQL As String) As Boolean
    ...
    Public Shared Function ejecutarNonQuerySQLFE(ByVal pSQL As String) As Boolean
    ...
    Public Sub cerrarconexionMFG_CuerosODBC()
        ...
        Catch ex As Exception
            ...
            Log.EscbribirLinea_Log("Error al cerrar la conexion ODBC")
        End Try
    ...
    Public Sub cerrarConexionMFG_Ebfonse()
        ...
        Catch ex As Exception
            Console.Write("Error al cerrar la conexion MFG_Cueros")
            Log.EscbribirLinea_Log("Error al cerrar la MFG_Cueros")
        End Try

    End Sub

    Public Shared Sub cerrarDataReaderSQLFE()

        Try
            If Not rsSQLFE.IsClosed Then
                rsSQLFE.Close()
            End If
        Catch ex As Exception
            Console.Write("Error al cerrar el data reader de SQL")
            Log.EscbribirLinea_Log("Error al cerrar el data reader de SQL")
        End Try
    ...
    Public Shared Function BeginTransSQLFE() As Boolean
    ...
    Public Shared Function CommitSQLFE() As Boolean
