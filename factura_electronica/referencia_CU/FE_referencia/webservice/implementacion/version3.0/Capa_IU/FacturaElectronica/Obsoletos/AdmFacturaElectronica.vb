...
Public Class AdmFacturaElectronica
    ...
    '    'System.Diagnostics.Log.EscbribirLinea_Log("Modo de operacion: " + modo_operacion.ToString)
    '    unDetalle_ivaDAO.Obtener(pun_comprobante.idsolicitud)
    '    unDetalle_tributosDAO.Obtener(pun_comprobante.idsolicitud)
    '    uncbtesasocDAO.obtenerCbtesasoc(pun_comprobante.idsolicitud)
    '    'System.Diagnostics.Log.EscbribirLinea_Log("Solicitando Token y Firma")
    ...
    '            System.Diagnostics.Log.EscbribirLinea_Log(Me.error)
    '            Exit Function
    '        End If
    ...
    '        End If
    '    End If
    '    'System.Diagnostics.Log.EscbribirLinea_Log("Token " + objAccesoTA.Token.ToString)
    '    'System.Diagnostics.Log.EscbribirLinea_Log("Sign " + objAccesoTA.Sign.ToString)
    '    Try
    ...
    '        'System.Diagnostics.Log.EscbribirLinea_Log("Estableciendo comunicación con AFIP")
    '        If modo_operacion = "Homologacion" Then
    ...
    '        Exit Function
    '    End Try
    '    'System.Diagnostics.Log.EscbribirLinea_Log("Respuesta: " + respuesta.ToString)
    '    If respuesta = "R" Then
    ...
    '                    Exit Function
    '                End If
    '                'System.Diagnostics.Log.EscbribirLinea_Log("Guardando observaciones.")
    ...
    '            'System.Diagnostics.Log.EscbribirLinea_Log("Actualizando datos del comprobante")
    ...
    '            'System.Diagnostics.Log.EscbribirLinea_Log("Error del comprobante")
    ...
    '    System.Diagnostics.Log.EscbribirLinea_Log("<--INICIA GRABACION CAE--> ")
    '    System.Diagnostics.Log.EscbribirLinea_Log("ID: " + unComprobantes_ml.idsolicitud.valor.ToString)
    '    System.Diagnostics.Log.EscbribirLinea_Log("CAE: " + unComprobantes_ml.CAE.valor)
    '    System.Diagnostics.Log.EscbribirLinea_Log("CAEFchVto: " + unComprobantes_ml.CAEFchVto.valor)
    '    System.Diagnostics.Log.EscbribirLinea_Log("DocNro AFIP: " + unComprobantes_ml.nro_doc_afip.valor.ToString)
    '    System.Diagnostics.Log.EscbribirLinea_Log("CbteFch: " + unComprobantes_ml.CbteFch.valor.ToString)
    '    System.Diagnostics.Log.EscbribirLinea_Log("<FINALIZA GRABACION CAE> ")

    '    System.Diagnostics.Log.EscbribirLinea_Log("Comprobante_Aprobado")
    '    If Not unComprobante_mlDAO.actualizarComprobante(unComprobantes_ml) Then
    '        Me.error = unComprobante_mlDAO.error
    '        Exit Function
    '    End If
    ...
    '    System.Diagnostics.Log.EscbribirLinea_Log("Actualizando base de datos local y Magma")
    ...
    '        Me.error = unComprobante_mlDAO.error
    '        System.Diagnostics.Log.EscbribirLinea_Log(unComprobante_mlDAO.error)
    '        AdmConexiones.RollbackSQL()

    '    Else
    '        AdmConexiones.CommitSQLFE()
    '        System.Diagnostics.Log.EscbribirLinea_Log("Commit Realizado con éxito!!!")
    '    End If


    '    'ufn_actualizarDatosFacturaElectronica_v1_3()
    '    System.Diagnostics.Log.EscbribirLinea_Log("Grabando estado de envío")
    ...
    '            Exit Function
    '        End If
    '        System.Diagnostics.Log.EscbribirLinea_Log("Comprobante_Asignado")
    '    Else
    ...
    '        End If
    '        solicitarCAE = False
    '        System.Diagnostics.Log.EscbribirLinea_Log("No asignado")
    '        Exit Function
    '    End If
    ...
    '    unv_cmpasociados_exDAO.Obtener(pun_comprobante.Id)
    '    unv_Items_exDAO.Obtener(pun_comprobante.Id)
    '    unv_PermisoDestino_exDAO.Obtener(pun_comprobante.Id)

    '    ' System.Diagnostics.Log.EscbribirLinea_Log("Solicitando Token")

    '    If modo_operacion = "Homologacion" Then
    '        'System.Diagnostics.Log.EscbribirLinea_Log("Modo de operacion: 'Homologacion'")
    '        If Not objAccesoTA.obtenerTicketHomologacion_EX() Then
    '            Me.error = "no se puede obtener el ticket de acceso"
    '            'System.Diagnostics.Log.EscbribirLinea_Log(objAccesoTA.Error + " " + Me.error)
    '            Exit Function
    '        End If
    '    ElseIf modo_operacion = "Produccion" Then
    '        'System.Diagnostics.Log.EscbribirLinea_Log("Modo de operacion: 'Produccion'")
    ...
    '        'System.Diagnostics.Log.EscbribirLinea_Log("Adaptando Formatos a AFIP")
    ...
    '        End If
    '        'System.Diagnostics.Log.EscbribirLinea_Log(ex.Message)
    '        Exit Function
    '    End Try
    ...
    '            Else
    '                Me.error = "Comprobante rechazado por error desconocido."
    '                'System.Diagnostics.Log.EscbribirLinea_Log("Comprobante rechazado por error desconocido.")
    '            End If
    '            Exit Function
    '        ElseIf modo_operacion = "Produccion" Then
    ...
    '            If Not un_comprobanteDAO.Actualizar(un_comprobante) Then
    ...
    '        un_comprobanteDAO.ActualizarEstadoEnvio(un_comprobante)
    '        System.Diagnostics.Log.EscbribirLinea_Log("Comprobante_Asignado")
    '    Else
    '        un_comprobante.estado_envio.Valor = "No Asignado"
    '        un_comprobanteDAO.ActualizarEstadoEnvio(un_comprobante)
    '        solicitarCAE_ex = False
    '        System.Diagnostics.Log.EscbribirLinea_Log("Comprobante No Asignado")
    '        Exit Function
    '    End If
    ...
    '            System.Diagnostics.Log.EscbribirLinea_Log("No existen comprobantes para enviar a AFIP")
    '            Exit Function
    '        End If
    ...
    '        System.Diagnostics.Log.EscbribirLinea_Log([error])
    '        Exit Function
    '    End If
    ...
    '    System.Diagnostics.Log.EscbribirLinea_Log("Adaptando formato Afip - Homologacion")
    ...
    '    System.Diagnostics.Log.EscbribirLinea_Log("Último Nro de Comprobante en AFIP (Homo): " + objHomoFEUltNroResponse.CbteNro.ToString)
    ...
    '    End With
    '    Dim i As Integer = 0
    '    For Each unDetalle_tributos As Detalle_tributos In unDetalle_tributosDAO.ListaObtenida
    ...
    '    i = 0
    '    For Each unDetalle_iva As Detalle_iva In unDetalle_ivaDAO.ListaObtenida
    ...
    '        System.Diagnostics.Log.EscbribirLinea_Log("Lista de Detalle_tributos creada")
    '    End If
    '    If existeCmpAsociados Then
    '        objHomoFEDetalleRequest.CbtesAsoc = ArrayOfcbtesasocHomo
    '        System.Diagnostics.Log.EscbribirLinea_Log("Lista de Detalles_Asoc creada")
    '    End If
    ...
    '    System.Diagnostics.Log.EscbribirLinea_Log("Adaptacion Homologacion Completa")
    ...
    '    System.Diagnostics.Log.EscbribirLinea_Log("Adaptando formato Afip - Homologacion - EX")
    ...
    '    System.Diagnostics.Log.EscbribirLinea_Log("Último Nro de Comprobante de Exportacion en AFIP (Homo): " + objHomoFEUltNroResponse.CbteNro().ToString)
    ...
    '        System.Diagnostics.Log.EscbribirLinea_Log("Lista de Items creada")
    '    End If
    '    If existePermisosDestino Then
    '        objHomoFEXRequest.Permisos = ArrayOfv_PermisosDestinoHomo
    '        System.Diagnostics.Log.EscbribirLinea_Log("Lista de PermisosDestino creada")
    '    End If
    '    If existeCmpAsociados Then
    '        objHomoFEXRequest.Cmps_asoc = ArrayOfv_cmpasociados_homo
    '        System.Diagnostics.Log.EscbribirLinea_Log("Lista de CmpAsociados creada")
    '    End If
    ...
    '    System.Diagnostics.Log.EscbribirLinea_Log("Adaptando formato Afip - Produccion - EX")
    ...
    '    System.Diagnostics.Log.EscbribirLinea_Log("Último Nro de Comprobante de Exportacion en AFIP (Prod): " + objProdFEUltNroResponse.CbteNro().ToString)
    ...
    '    System.Diagnostics.Log.EscbribirLinea_Log("Adaptacion Prodlogacion Completa")
