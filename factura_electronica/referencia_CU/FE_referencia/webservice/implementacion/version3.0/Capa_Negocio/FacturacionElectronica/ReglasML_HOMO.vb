...
Public Class ReglasML_HOMO
    ...
    Private Sub CompletarComprobanteConResponse(ByRef pObjComprobante As Comprobantes_ml, ByRef pObjRespuesta As ar.gov.afip.wshomofev1.FECAEResponse, ByVal pEstadoEnvio As String)
        Try
