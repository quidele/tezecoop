...
Public Class Frm_ObtieneCAE_EX
    ...
    Private Sub btn_procesar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_procesar.Click
        ...
        Log.EscbribirLinea_Log(numeroCbte.ToString)
        Log.EscbribirLinea_Log(DGV_listaComprobantes.SelectedRows(0).Cells(1).Value.ToString)
        Log.EscbribirLinea_Log(ToolStripStatusLabel1.Text) 'Escribe el nombre del usuario
        ...
        If Not un_v_comprobantes_exDAO.InsertarComprobantesEXFE(idSolicitud) Then
            ...
            Me.Visible = True
            Log.EscbribirLinea_Log(un_v_comprobantes_exDAO.error)
