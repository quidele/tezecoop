...
namespace FEAFIPPruebas.wsaa_homo {
    ...
    public interface LoginCMS {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(FEAFIPPruebas.wsaa_homo.LoginFault), Action="", Name="fault")]
        FEAFIPPruebas.wsaa_homo.loginCmsResponse loginCms(FEAFIPPruebas.wsaa_homo.loginCmsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<FEAFIPPruebas.wsaa_homo.loginCmsResponse> loginCmsAsync(FEAFIPPruebas.wsaa_homo.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LoginCMSChannel : FEAFIPPruebas.wsaa_homo.LoginCMS, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<FEAFIPPruebas.wsaa_homo.LoginCMS>, FEAFIPPruebas.wsaa_homo.LoginCMS {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        FEAFIPPruebas.wsaa_homo.loginCmsResponse FEAFIPPruebas.wsaa_homo.LoginCMS.loginCms(FEAFIPPruebas.wsaa_homo.loginCmsRequest request) {
            return base.Channel.loginCms(request);
        }
        
        public string loginCms(string in0) {
            FEAFIPPruebas.wsaa_homo.loginCmsRequest inValue = new FEAFIPPruebas.wsaa_homo.loginCmsRequest();
            inValue.in0 = in0;
            FEAFIPPruebas.wsaa_homo.loginCmsResponse retVal = ((FEAFIPPruebas.wsaa_homo.LoginCMS)(this)).loginCms(inValue);
            return retVal.loginCmsReturn;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<FEAFIPPruebas.wsaa_homo.loginCmsResponse> FEAFIPPruebas.wsaa_homo.LoginCMS.loginCmsAsync(FEAFIPPruebas.wsaa_homo.loginCmsRequest request) {
            return base.Channel.loginCmsAsync(request);
        }
        
        public System.Threading.Tasks.Task<FEAFIPPruebas.wsaa_homo.loginCmsResponse> loginCmsAsync(string in0) {
            FEAFIPPruebas.wsaa_homo.loginCmsRequest inValue = new FEAFIPPruebas.wsaa_homo.loginCmsRequest();
            inValue.in0 = in0;
            return ((FEAFIPPruebas.wsaa_homo.LoginCMS)(this)).loginCmsAsync(inValue);
        }
    }
}
