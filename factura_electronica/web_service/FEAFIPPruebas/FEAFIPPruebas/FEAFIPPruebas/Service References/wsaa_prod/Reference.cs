...
namespace FEAFIPPruebas.wsaa_prod {
    ...
    public interface LoginCMS {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(FEAFIPPruebas.wsaa_prod.LoginFault), Action="", Name="fault")]
        FEAFIPPruebas.wsaa_prod.loginCmsResponse loginCms(FEAFIPPruebas.wsaa_prod.loginCmsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<FEAFIPPruebas.wsaa_prod.loginCmsResponse> loginCmsAsync(FEAFIPPruebas.wsaa_prod.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LoginCMSChannel : FEAFIPPruebas.wsaa_prod.LoginCMS, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<FEAFIPPruebas.wsaa_prod.LoginCMS>, FEAFIPPruebas.wsaa_prod.LoginCMS {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        FEAFIPPruebas.wsaa_prod.loginCmsResponse FEAFIPPruebas.wsaa_prod.LoginCMS.loginCms(FEAFIPPruebas.wsaa_prod.loginCmsRequest request) {
            return base.Channel.loginCms(request);
        }
        
        public string loginCms(string in0) {
            FEAFIPPruebas.wsaa_prod.loginCmsRequest inValue = new FEAFIPPruebas.wsaa_prod.loginCmsRequest();
            inValue.in0 = in0;
            FEAFIPPruebas.wsaa_prod.loginCmsResponse retVal = ((FEAFIPPruebas.wsaa_prod.LoginCMS)(this)).loginCms(inValue);
            return retVal.loginCmsReturn;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<FEAFIPPruebas.wsaa_prod.loginCmsResponse> FEAFIPPruebas.wsaa_prod.LoginCMS.loginCmsAsync(FEAFIPPruebas.wsaa_prod.loginCmsRequest request) {
            return base.Channel.loginCmsAsync(request);
        }
        
        public System.Threading.Tasks.Task<FEAFIPPruebas.wsaa_prod.loginCmsResponse> loginCmsAsync(string in0) {
            FEAFIPPruebas.wsaa_prod.loginCmsRequest inValue = new FEAFIPPruebas.wsaa_prod.loginCmsRequest();
            inValue.in0 = in0;
            return ((FEAFIPPruebas.wsaa_prod.LoginCMS)(this)).loginCmsAsync(inValue);
        }
    }
}
