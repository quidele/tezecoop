...
Class AccesoAFIP_ML_HOMO
    ...
    Public Function ObtenerRespuestaAFIP(ByVal pObjComprobantesFE As Comprobantes_ml, ByVal pObjTicket As Ticket, ByVal pCuitEmpresa As String) As ar.gov.afip.wshomofev1.FECAEResponse
        Try
    ...
    Private Function CrearObjetoComprobanteFE_Desde_ResultGet(pResult As ar.gov.afip.wshomofev1.FECompConsultarResponse) As Comprobantes_ml
        Try
    ...
    Private Function CrearComprobanteML_Desde_ResultGet(pResult As ar.gov.afip.wshomofev1.FECompConsultarResponse) As Comprobantes_ml
        Try
            Dim objCbteFE As New Comprobantes_ml
    ...
    Private Function CrearDetalleRequest_desde_ComprobanteFE(pObjComprobanteFE As Comprobantes_ml, pCbteDesde As Integer, pCbteHasta As Integer) As ar.gov.afip.wshomofev1.FECAEDetRequest
        Try
