...
Public Class Encriptado
    ...
    Public Shared Function EncryptText(ByVal strPass As String, ByVal strUsuario As String) As String
    ...
    ''' <param name="strUsuario"></param>
    ''' <returns>string</returns>
    Public Shared Function DecryptText(ByVal strPassEncript As String, ByVal strUsuario As String) As String
        Dim i As Integer, C As Integer
        Dim strBuff As String = ""
