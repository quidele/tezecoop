...
Public Class RegionalUtils
    ...
    '                Log.EscbribirLinea_Log("El número está fuera del rango soportado por la función (0 - " & System.Int64.MaxValue.ToString & ")")
    ...
    '                Log.EscbribirLinea_Log("El número está fuera del rango soportado por la función auxiliar CientosAPalabras(1 - 999)")
