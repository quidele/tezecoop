...
Dim resp                        As Integer
    ...
    If objUnidadesMoviles.CopiarMDBPendriveaDisco(Me.cbUnidadesRemovibles.Text) Then
        If Not Configurando_MDB(App.Path + "\SincroManual\Puesto_ADM.mdb") Then
            ...
            MsgBox "No se pudo sincronizar la información de Puesto a ADM." + vbCrLf + "Error: " + objUnidadesMoviles.Error, vbInformation, "Atencion"
        Else
    ...
    MsgBox "Proceso Finalizado. Envíe el Pendrive a los Puestos.", vbInformation + vbDefaultButton1, "Atención"
    Screen.MousePointer = vbDefault
    Me.Enabled = True
    Unload Me
