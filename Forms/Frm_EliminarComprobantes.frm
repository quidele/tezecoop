...
Dim bModificoFecha   As Boolean
    ...
    If nrTalonario_anterior <> Trim(ObtenerCampo("nrTalonario")) Or _
       ...
       Else
           ...
           MsgBox "El número de talonario,número y/o letra del comprobante se ha actualizado con éxito.", vbInformation + vbDefaultButton1, "Atención"
       End If
    ...
    If dtComprobante_anterior <> ObtenerCampo("dtComprobante") Then
            ...
            If Not objbasededatos.ExecStoredProcedures(strSQL) Then
                ...
                Exit Function
            Else
                MsgBox "La fecha se ha actualizado con éxito.", vbInformation + vbDefaultButton1, "Atención"
            End If
        bModificoFecha = True
    Else
...
Dim resp As Byte
    ...
    If Not actualizarFechaActualizaciondelaCaja() Then
         objbasededatos.RollBackTrans
         MsgBox "Error al grabar la tabla de vaja, por favor intente mas tarde. Error extendido: " + ObjTablasIO.Error, vbCritical, "Atención"
         Exit Function
    End If
