...
If  exist C:\Gestion\GestiondeViajesADM\Versiones_Anteriores\08062018\GestiondeViajes.exe  (
	...
	MD C:\Gestion\GestiondeViajesADM\Versiones_Anteriores\08062018
	xcopy C:\Gestion\GestiondeViajesADM\GestiondeViajes.exe C:\Gestion\GestiondeViajesADM\Versiones_Anteriores\08062018 /y
	xcopy C:\Gestion\GestiondeViajesFacturacionRETORNO\GestiondeViajes.exe C:\Gestion\GestiondeViajesFacturacionRETORNO\Versiones_Anteriores\08062018  /y
	xcopy GestiondeViajes.exe C:\Gestion\GestiondeViajesADM /y
	xcopy GestiondeViajes.exe C:\Gestion\GestiondeViajesFacturacionRETORNO /y
)
