...
REM xcopy C:\Windows\sc\sg_git\tezecoop\Reportes\prod\rpt_facturachico_imprime_continuo_v4_7.rpt C:\Gestion\GestiondeViajesADM /y
REM xcopy C:\Windows\sc\sg_git\tezecoop\Reportes\prod\rpt_facturachico_imprime_continuo_v4_7.rpt C:\Gestion\GestiondeViajesFacturacionRETORNO /y
