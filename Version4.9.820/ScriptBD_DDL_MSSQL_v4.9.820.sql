-- Cambios de DDL version 4.9.820
use dbSG2000
go
...
if NOT EXISTS (select * from sys.procedures where name  = 'spu_conciliarAutomaticamente_bkp_antes_v4_9_820') 
	EXEC sp_rename 'spu_conciliarAutomaticamente' , 'spu_conciliarAutomaticamente_bkp_antes_v4_9_820'
-- drop procedure spu_conciliarAutomaticamente_bkp_antes_v4__820
/*
sp_help 'dbo.spu_conciliarAutomaticamente'
sp_help 'dbo.spu_conciliarAutomaticamente_bkp_antes_v4__820'
*/
GO
