...
{
    public class RepositorioFacturaElectronica_Pruebas
    {
        private FacturaElectronica_PruebasEntities _repoFE;


        public RepositorioFacturaElectronica_Pruebas(FacturaElectronica_PruebasEntities pContext)
        {
            _repoFE = pContext;
        }
