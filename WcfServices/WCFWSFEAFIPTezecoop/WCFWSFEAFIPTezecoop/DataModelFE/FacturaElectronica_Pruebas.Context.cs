...
namespace WCFWSFEAFIPTezecoop.DataModelFE
{
    ...
    public partial class FacturaElectronica_PruebasEntities : DbContext
    {
        public FacturaElectronica_PruebasEntities()
            : base("name=FacturaElectronica_PruebasEntities")
        {
        }
