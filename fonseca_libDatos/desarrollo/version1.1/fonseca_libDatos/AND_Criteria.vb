        ...
        For Each listaoCampo As Object In lista_parametros
            Select Case listaoCampo.GetType().Name
                Case "AND_Criteria", "OR_Criteria"
                    resultado = IIf(resultado = "", listaoCampo.ejecutar(), resultado + " " + SQLAdapter.OPERADOR_AND + " " + listaoCampo.ejecutar())
                Case "CampoExtendido"
                    un_campo = listaoCampo
                    If Not un_campo.esNulo Then
                        resultado = IIf(resultado = "", resultado, resultado + " " + SQLAdapter.OPERADOR_AND)
