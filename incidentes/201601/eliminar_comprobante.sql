...
select * from   TB_ComprobantesDetalle    where   nrComprobante ='00190360' and nrTalonario = '0001' and tpComprobante ='m' and tpletra='m'

select * from   tb_comprobantes    where   nrComprobante ='00190360' and nrTalonario = '0001' and tpComprobante ='m' and tpletra='m'
