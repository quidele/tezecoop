select * from tb_comprobantesDetalle where nrComprobante = '00197992' and nrTalonario = '0006'


select * from sys.procedures  where name like '%Actualiza%'

sp_helptext '[SP_ActualizarComprobante_v3_7]'

exec  [SP_ActualizarComprobante_v4_9]
@nrTalonario_param        = '0006',  /* FORMATO 0000*/
@nrComprobante_param      ='00197992',
@tpComprobante_param      ='BA',
@tpLetra_param            ='Z',
@nrTalonario_new_param     = '0006', 
@nrComprobante_new_param  ='00197992',
@tpComprobante_new_param  ='B',
@tpLetra_new_param       ='B',
@dtComprobante_new_param  = '20100428',
@nrCierre_param				=null,
@cdCondVenta_new_param	  =null,
@tpComision_new_param	  =null,
@vlComision_new_param     = null,
@solo_cambio_cabecera_comprobante='SI'


exec  [SP_ActualizarComprobante_v4_9]
@nrTalonario_param        = '0001',  /* FORMATO 0000*/
@nrComprobante_param      ='00197992',
...
CREATE     procedure [SP_ActualizarComprobante_v4_9]
