 ...
 select * from tmp_desbloquear_viajes_18092015 x inner join TB_Cupones y 
							on x.nrComprabanteCliente = y.nrComprabanteCliente and x.vlMontoCupon = y.vlMontoCupon  and x.nrLicencia = y.nrLicencia
