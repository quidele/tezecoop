...
select b.dsRazonSocial 'CLIENTE', flCompensado 'COBRADO', dtCompensado 'FECHA COBRO', 
       vlMontoCupon 'MONTO' ,
       dtCupon 'FECHA LIQ', 
       a.tpLetraCliente +'-'+
       ...
       dsDestino 'DETALLE'  ,
        a.*
       from tb_cupones a, tb_clientes b 
where YEAR(a.dtCupon)=2009  and a.nrLicencia=999
and a.cdCliente = b.cdCliente  ORDER BY dtCupon asc
...
where 
	YEAR(a.dtCupon)=2009  and a.nrLicencia<>999
