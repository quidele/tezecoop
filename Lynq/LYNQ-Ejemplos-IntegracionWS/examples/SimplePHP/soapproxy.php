<?php
	...
	define("DIRECTORY_SERVICE_WSDL", "http://apps.gpsgate.com/Services/Directory.asmx?wsdl");
	define("TRACKS_SERVICE_WSDL", "http://apps.gpsgate.com/Services/Tracks.asmx?wsdl");
	...
	class SoapProxy {
		...
		private function __construct() {
			...
			// --------------
			// Since this sample do not utalize the tracks SOAP service this is disabled.
			// Uncomment this part to be enabled to use the track service through $this->trackService property.
			// ---------------
			
			/*
			$this->tracksService = new SoapClient(
				TRACKS_SERVICE_WSDL,
				array(
					"trace" => 1,
					"exceptions" => 1
