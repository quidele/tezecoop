...
<Obsolete("Esta clase está obsoleta. Debe usar la clase AdmConexionesBD en su lugar.")> _
...
#Region "   Abrir Conexiones"
    ...
    Public Function AbrirConexionRRHH_SQL() As Boolean
        ...
        ' clave = objEncriptado.EncryptText("ITf0nBD", "USRSG2013")

        ' USRSG2013 ;Pwd=ITf0nBD"
...
#End Region
    ...
    <Obsolete("El uso de esta clase es obsoleto. Usar la clase AdmConexionesBD")> _
