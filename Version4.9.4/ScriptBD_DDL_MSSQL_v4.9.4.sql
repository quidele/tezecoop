...
if exists (SELECT * FROM  INFORMATION_SCHEMA.ROUTINES where SPECIFIC_NAME ='UDF_obtenerCampoAFIP_cod_dgi_v4_9_4' )
	drop function  dbo.UDF_obtenerCampoAFIP_cod_dgi_v4_9_4

GO


--  select   [dbo].[UDF_obtenerCampoAFIP_cod_dgi_v4_9] ('CF' , '20100177341         ','580')
CREATE  FUNCTION [dbo].[UDF_obtenerCampoAFIP_cod_dgi_v4_9_4] (@tpIVA  varchar(4) ,  @nrDoc as varchar(100), @vlTotalGeneral as float  )
RETURNS varchar(50)
BEGIN
...
BEGIN
	...
	ELSE
			set @valor_retorno = '80'  -- VERIFICAR ESTA SITUACION
END
ELSE
BEGIN
...
select @cod_dgi = [dbo].[UDF_obtenerCampoAFIP_cod_dgi_v4_9_4] (@tpIVA, @nrDoc,@vlTotalGeneral) 
...
select * from tb_puestos
 ...
 exec  [dbo].[spu_obtieneDatosCITIVentas_v4_9_4] @mes = 11 , @anio = 2016 , @renglon = 9910
 exec  [dbo].[spu_obtieneDatosCITIVentas_v4_9_4] @mes = 11 , @anio = 2016 , @renglon = 10335
 exec  [dbo].[spu_obtieneDatosCITIVentas_v4_9_4] @mes = 11 , @anio = 2016 , @renglon = 14397
 exec  [dbo].[spu_obtieneDatosCITIVentas_v4_9_4] @mes = 11 , @anio = 2016 , @renglon = 16913
 exec  [dbo].[spu_obtieneDatosCITIVentas_v4_9_4] @mes = 11 , @anio = 2016 , @renglon = 16914
 ...
 select '0007' as nrTalonario , 	'00494989' as nrComprobante, 	'B' as tpLetra  , 	'FA' as tpComprobante  into zTB_Comprobantes_201611_corrige_errores

 insert into zTB_Comprobantes_201611_corrige_errores
 select '0007' as nrTalonario , 	'00494699' as nrComprobante, 	'B' as tpLetra  , 	'FA' as tpComprobante 
 
 insert into zTB_Comprobantes_201611_corrige_errores
 select '0006' as nrTalonario , 	'00713621' as nrComprobante, 	'B' as tpLetra  , 	'FA' as tpComprobante 
 
 insert into zTB_Comprobantes_201611_corrige_errores
 select '0006' as nrTalonario , 	'00712711' as nrComprobante, 	'B' as tpLetra  , 	'FA' as tpComprobante 
 
 insert into zTB_Comprobantes_201611_corrige_errores
 select '0007' as nrTalonario , 	'00491728' as nrComprobante, 	'B' as tpLetra  , 	'FA' as tpComprobante 
