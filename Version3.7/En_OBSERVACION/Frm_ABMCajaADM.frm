...
Dim strValor    As String
    ...
    Case "Agregar"
           ...
           ' Eulises objCajas.ObtenerUltimaCajaAdmCerrada
           '  objCajas.ObtenerSaldoInicialparaAperturadeCajaADM
...
Dim nombrereporte As String
    ...
    If objSPs.ExecSP() Then
        If objSPs.rs_resultados("version") = "v3_2" Then
          nombrereporte = "rpt_resumendecajaadm_v3_3.rpt"
        Else
          nombrereporte = "rpt_ResumendeCajaADM_v3_1.rpt"
        End If
    End If
...
Dim vlDiaDolar As Single
    ...
    ' vlDiaEuro = CSng(objConfig.vlDiaEuro)
    ' vlDiaDolar = CSng(objConfig.vlDiaDolar)
